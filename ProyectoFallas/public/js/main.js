...
var divTodasFallas = document.createElement("div");
    ...
    resultadoJSON.forEach(fallas => {
       ...
       /* if (fecha1.value < fecha2.value && 
            ...
            if (secciones.value == "Todas") {
                ...
                if (principalChecked) {
                    cargarFalla(fallas.properties.boceto,fallas.properties.nombre);
                
                } //Si esta pulsado el radiobutton de la falla infantil establecemos las fotos de las fallas infantil.
                else {
                    cargarFalla(fallas.properties.boceto_i,fallas.properties.nombre);
...
function cargarFalla(boceto,nombreFalla) {
